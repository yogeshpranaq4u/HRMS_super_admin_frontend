...
import EditInvoice from "../../../Admin/AdminPage/Billing/Component/EditInvoice";
          ...
          {rowData?.invoice_status === "MailSent" ? (
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
              <img
                ...
                style={{ width: 20, height: 20 }}
              />
              <span style={{ verticalAlign: "middle", textAlign:'center'}}>Draft</span>
            </div>
          )}
        </div>
      )
