...
const OrganisationTree = () => {
  ...
  useEffect(() => {
    const updateMargin = () => {
      ...
      if (screenWidth < 600) {
        setMarginLeft(-10); // Small screen
      } else if (screenWidth < 1024) {
        setMarginLeft(-100); // Medium screen
      } else {
        setMarginLeft(100); // Large screen
      }
    };
      ...
      <div className="page-wrapper">
        <div className="content">
          <div className="org-chart">
              ...
              <div>
                ...
                >
                  <img
                    src={Start}
                    alt="Leader 1"
                    style={{ width: 35, height: 35, marginTop: -19 }}
                  />
                </div>
              </div>
            ...
            <div className="connector-line" style={{ marginLeft: 2 }}>
