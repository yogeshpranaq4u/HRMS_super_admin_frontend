...
import { setAllInactiveEmployee, setUserDetails } from "../../Redux/Action";
import { FaLock, FaLockOpen } from "react-icons/fa";
import { useSelector } from "react-redux";

const EditInactiveEMployee = ({ open, onClose, user }) => {
const setLoading = () => { };
  const logout = () => { };
...
export default EditInactiveEMployee;
