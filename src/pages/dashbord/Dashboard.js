      ...
      <div className="page-wrapper">
        <div className="content">
          ...
          <div className="row">
            ...
            <Card2 data={{title:'Recent Transactions',type:'Transactions'}} />
            <Card2 data={{title:'Recently Registered',type:'Registered'}} />
            <Card2 data={{title:'Recent Plan Expired',type:'Plan Expired'}} />
            {/* <!-- /Recent Transactions -->
